...
enum KLineVolType { VOL, MACD, KDJ, BOLL }

class KLineVolPainter extends CustomPainter {
  final List datas;
  ...
  KLineVolPainter({
    ...
    this.showDate = true,
    this.type = KLineVolType.MACD,
    this.isLongPress = false,
    this.onSelected,
    required this.datas,
  });

  late double maxValue; //最大值
  late double minValue; //最小值
  Map? selectedMap;
